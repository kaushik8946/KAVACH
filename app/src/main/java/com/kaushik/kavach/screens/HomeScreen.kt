    ...
    Column(
        ...
        Card(
            ...
            onClick = {
                ...
                var hasSmsPermission = ContextCompat.checkSelfPermission(
                    context,
                ...
                if (false in listOf(hasMicPermission, hasLocationPermission, hasSmsPermission)) {
                    navController.navigate("alert-voice")
                } else {
